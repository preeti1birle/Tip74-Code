...
<div class="panel-body" ng-controller="PageController" ng-init="getList()"><!-- Body -->
	...
	<!-- Top container -->
	<div class="clearfix mt-2 mb-2 float-right">
        <button class="btn btn-success btn-sm ml-1" ng-click="loadFormAdd();"> Add Sport </button>
	</div>
	<!-- Top container/ -->
		...
		<table class="table table-striped table-condensed table-hover table-sortable" ng-show="data.dataList.length > 0">
			...
			<tbody id="tabledivbody">
					...
					<tr scope="row" ng-repeat="(key, row) in data.dataList">	
						...
						<td>
							<button class="btn btn-success btn-sm" ng-click="updateConfigData(row.GameTypeID,row.Name,row.Status)">Update</button>
						</td>
					</tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title h5">Add Sport</h3>     	
