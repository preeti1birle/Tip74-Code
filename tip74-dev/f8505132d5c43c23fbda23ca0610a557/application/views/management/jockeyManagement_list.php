...
<div class="panel-body" ng-controller="PageController"><!-- Body -->
	...
	<div class="clearfix mt-2 mb-2" ng-if="data.dataList.length"> 
		...
		<div class="float-right">
			...
			<button class="btn btn-success btn-sm" ng-click="loadFormAdd();">Add Jockey</button>
		</div>
	</div>
	<!-- Top container/ -->
    <!-- Data table -->
    <div class="table-responsive block_pad_md" infinite-scroll="getJockeyList()" infinite-scroll-disabled='data.listLoading' infinite-scroll-distance="0"> 
        <!-- loading -->
        ...
        <table class="table table-striped table-condensed table-hover table-sortable all-table-scroll football_series_table cricket_series_table" ng-if="data.dataList.length">
            ...
            <thead>
                <tr>
                    ...
                    <th style="min-width: 200px;" class="text-left">Jockey Name</th>
            ...
            <tbody id="tabledivbody">
				...
				<tr scope="row" ng-repeat="(key, value) in data.dataList" id="sectionsid">
                    ...
                    <td style="min-width: 200px;" class="text-left">
							<strong>{{value.JockeyName}}</strong>
                    </td>
                    <td class="text-center">
                        <div class="dropdown action_toggle">
                            ...
                            <div class="dropdown-menu dropdown-menu-left">
                                <a class="dropdown-item" href="" ng-click="loadFormEdit(key, value.JockeyGUID, 'Jockey')">Edit</a>
                                <a class="dropdown-item" href="javascript:void(0)" ng-click="loadFormDelete(key, value.JockeyGUID, 'Jockey')">Delete</a>
                            </div>
                        </div>
                    </td>
                </tr>
		...
		<div class="modal-dialog modal-md" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h3 class="modal-title h5">Add Jockey</h3>     	
	...
	<div class="modal fade" id="edit_model">
		<div class="modal-dialog modal-md" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h3 class="modal-title h5">Edit Jockey</h3>     	
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				</div>
	...
	<div class="modal fade" id="delete_model">
		<div class="modal-dialog modal-md" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h3 class="modal-title h5">Delete Jockey</h3>     	
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				</div>
				<!-- form -->
