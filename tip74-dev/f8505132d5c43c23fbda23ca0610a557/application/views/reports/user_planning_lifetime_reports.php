...
<div class="panel-body" ng-controller="PageController"><!-- Body -->
    ...
    <div class="clearfix mt-2 mb-2">
        ...
        <span> Date: <span id="Start_Date"> {{UserDataReports.FilterText}} </span><br>
            ...
            <div class="modal-content">
                ...
                <form id="filterForm1" role="form" autocomplete="off" class="ng-pristine ng-valid">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-success btn-sm" data-dismiss="modal" onclick="check()" ng-disabled="editDataLoading" ng-click="getUserPlanningLifetimeReport()">Apply</button>
                    </div>
