...
<div class="panel-body" ng-controller="PageController" ng-init="getSeasonList();"><!-- Body -->
	...
	<div class="clearfix mt-2 mb-2"> 
		...
		<div class="float-right">
			<button class="btn btn-success btn-sm" ng-click="loadFormAdd();">Add Competition</button>
		</div>
	</div>
	<!-- Top container/ -->
        ...
        <table class="table table-striped table-condensed table-hover table-sortable all-table-scroll football_series_table cricket_series_table" ng-if="data.dataList.length">
            ...
            <thead>
                <tr>
                    ...
                    <th style="min-width: 200px;" class="text-left">Competition Name</th>
                    <!-- <th>Rounds</th> -->
            ...
            <tbody id="tabledivbody">
                ...
                <tr scope="row" ng-repeat="(key, row) in data.dataList" id="sectionsid_{{row.MenuOrder}}.{{row.CategoryID}}">
                	<td class="user_table"  style="max-width: 50px;">
                        <img ng-src="{{row.CompetitionFlag}}" width="70px" height="45px;">
                    </td>
                    <td style="min-width: 200px;" class="text-left">
						<a><strong>{{row.CompetitionName}}</strong></a>
						<!-- href="football/roundList?CompetitionGUID={{row.CompetitionGUID}}" target="_blank" -->
                    </td>
                    <!-- <td>
                        {{row.TotalRounds}}
                    </td> -->
                    ...
                    <td class="text-center">
                        <div class="dropdown action_toggle">
                            ...
                            <div class="dropdown-menu dropdown-menu-left">
                                <a class="dropdown-item" href="" ng-click="loadFormEdit(key, row.CompetitionGUID)">Edit</a>
								<a class="dropdown-item" href="" ng-click="deleteCompetition(row.CompetitionGUID)">Delete</a>
								<!-- <a class="dropdown-item" target="_blank" href="football/roundList?CompetitionGUID={{row.CompetitionGUID}}">View Rounds</a> -->
                            </div>
                        </div>
                    </td>
                </tr>
		...
		<div class="modal-dialog modal-md" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h3 class="modal-title h5">Add Football/Competition</h3>     	
