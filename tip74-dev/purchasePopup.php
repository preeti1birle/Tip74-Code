<div class="modal fade purchase_modal site_modal" popup-handler id="entryPopup" tabindex="-1" role="dialog" aria-labelledby="modalLabelSmall" aria-hidden="true" >
                ...
                <div class="modal-body text-center  clearfix comon_body ammount_popup" ng-init="mode = 'Entry'">
                    <form name="EntryForm" novalidate="true">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom_select">
								<select class="customReadOnlyField" ng-required="true" name="entry" ng-model="EntriesID" ng-change="showEntryInfo(EntriesID)" >
    ...
    top: 4px;">
                        ...
                        <div class="">
                            <div class="button_right text-center">
                                <button class="btn_gradient px-4 py-2"  ng-click="purchaseEntry(SelectedWeekGUID)">Purchase</button>
